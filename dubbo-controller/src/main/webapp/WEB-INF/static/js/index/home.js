$(function () {
    ...
    //加载第一个tabs
    addTab("我的桌面", "showDesktop.do", "fa fa-home");
    ...
    $('#showUserInfo').tooltip({
        ...
        onUpdate: function (content) {
            content.panel({
                ...
                content: '<ul class="dropdown-menu"><li class="user-header"><img src="../.././images/index/photo.jpg" class="img-circle" alt="User Image"><p>Alexander Pierce - Web Developer<small>Member since Nov. 2012</small></p></li><li class="endbtndiv" style="margin-top:5px;"><a href="javascript:Profile();" class="easyui-linkbutton btns" style="float:left; margin-left:10px;">简介</a><a href="javascript:SignOut();" class="easyui-linkbutton btnc" style="width:80px;">退出</a></li></ul>'
            });
        },
        onShow: function () {
...
function loadAccordionMenu(parentId) {
    alert("通过AJAX获取左边菜单loadAccordionMenu");
